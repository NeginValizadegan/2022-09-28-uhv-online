...
address: "Online: Unix Shell & Version Control with Git at https://arizona.zoom.us/j/5204480364  ; Programming with R at https://riceuniversity.zoom.us/j/93141153622?pwd=NmJaMEJ0OU5ZSmZ1aGdCa0lRejhBZz09" # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Sep 28-30, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 AM - 2:00 PM CST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2022-08-28     # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-08-30        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Su Chen", "Michele Cosi", "Emilia Gan", "Negin Valizadegan"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["TBD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["aidova@uhv.edu","shilpa.phanse@hccs.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
